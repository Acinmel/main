...
export const DIGITAL_HUMAN_STYLES: readonly DigitalHumanStyleDef[] = [
  ...
  },
  {
    ...
    label: '律师版',
    content:
      '【任务】根据用户上传的正面人物自拍，生成一张可用于法律科普、律所介绍或商务口播的数字人半身形象，上半身出镜，从腰部以上露出。【风格要求】律师职业形象：深色西装、白衬衫，可搭配简洁领带或胸针；仪表干练、表情沉稳可信；背景为现代办公室、书架或浅色专业影棚背景；写实高清、肤质自然；无文字水印、无夸张配饰，单人出镜。',
  },
  {
    id: 'programmer',
    label: '程序员版',
    content:
      '【任务】根据用户上传的正面人物自拍，生成一张可用于技术分享、编程教学或产品讲解的数字人半身形象，上半身出镜，从腰部以上露出。【风格要求】程序员职业形象：简洁卫衣、休闲衬衫或针织衫，干净舒适；背景可为现代工位、虚化显示器或极简科技感背景；神态专注亲和，适合知识讲解；写实高清、自然光感；无代码文字水印、无屏幕可读敏感内容，单人出镜。',
  },
  {
    id: 'finance',
    label: '财务版',
    content:
      '【任务】根据用户上传的正面人物自拍，生成一张可用于财税知识、会计培训、企业财务汇报类口播的数字人半身形象，上半身出镜，从腰部以上露出。【风格要求】财务职业形象：商务衬衫、西装外套或简洁职业套装，色彩稳重；背景为明亮办公室、会议室或浅色数据感背景；表情清晰稳健、专业可信；写实高清；无文字水印、无复杂数字图表干扰，单人出镜。',
  },
  {
    id: 'chef',
    label: '厨师版',
    content:
      '【任务】根据用户上传的正面人物自拍，生成一张可用于美食教学、餐饮品牌介绍或厨房口播的数字人半身形象，上半身出镜，从腰部以上露出。【风格要求】厨师职业形象：干净厨师服或简洁餐饮工作服，可搭配厨师帽或围裙但不过度夸张；背景为明亮厨房、餐厅后厨或柔和虚化的美食场景；神态亲切专业；写实高清、服装整洁；无文字水印、无脏污杂乱，单人出镜。',
  },
] as const;
